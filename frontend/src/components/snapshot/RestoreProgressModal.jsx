...
const RestoreProgressModal = ({ progress }) => {
  ...
  return (
    <div className="fixed inset-0 z-[20000] bg-[#020617]/95 backdrop-blur-2xl flex items-center justify-center p-8 animate-in fade-in duration-500">
      <div className="max-w-2xl w-full space-y-12 relative">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-primary-400/60 font-black text-xs uppercase tracking-[0.5em] animate-pulse">
        ...
        {/* Stage Visualization */}
        <div className="bg-slate-900/50 border border-white/5 p-8 rounded-3xl space-y-8 relative overflow-hidden group">
          {/* Progress Info */}
          <div className="flex justify-between items-end">
            ...
            <div className="text-right">
              <span className="text-5xl font-black text-white italic drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">{progress.progress}%</span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-4 px-6 py-4 bg-amber-500/5 border border-amber-500/20 rounded-2xl">
          <LuTriangleAlert className="w-5 h-5 text-amber-500 animate-pulse" />
