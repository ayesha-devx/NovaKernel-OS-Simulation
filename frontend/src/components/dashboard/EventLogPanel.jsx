...
const EventLogPanel = () => {
  ...
  return (
    <div className="glass-premium rounded-[2.5rem] border border-white/10 flex flex-col h-full overflow-hidden font-mono-cyber relative group shadow-[0_0_40px_rgba(157,0,255,0.05)]">
      ...
      <div className="px-8 py-5 border-b border-white/5 bg-white/[0.02] flex items-center justify-between relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <span className="text-[10px] font-black text-text/80 uppercase tracking-[0.4em] font-orbitron">Kernel_Telemetry_Flux</span>
      ...
      <div className="flex-1 p-8 overflow-y-auto space-y-3 text-[12px] custom-scrollbar relative z-10 terminal-flicker bg-black/20">
        <AnimatePresence initial={false}>
          {logs.map((log, i) => (
            <motion.div 
              ...
              key={log.id || i} 
              className="flex gap-4 leading-relaxed group/log hover:bg-white/[0.02] p-2 rounded-lg transition-colors border-l-2 border-transparent hover:border-primary/30"
            >
