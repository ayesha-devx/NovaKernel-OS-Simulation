      ...
      <div className="relative min-h-screen">
        ...
        >
            ...
            <motion.div variants={itemVariants} className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-magenta/5 to-transparent rounded-[3rem] blur-3xl opacity-30 group-hover:opacity-60 transition-opacity" />
                <div className="relative glass-premium rounded-[3rem] p-12 border border-white/10 overflow-hidden shadow-[0_0_60px_rgba(157,0,255,0.05)]">
                   ...
                   <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12 relative z-10">
                      <div className="space-y-6">
                        <div className="flex items-center gap-8">
                           <div className="w-20 h-20 rounded-3xl bg-primary/20 border border-primary/30 flex items-center justify-center neon-border shadow-[0_0_30px_rgba(157,0,255,0.2)]">
                               <LuDatabase className="text-primary neon-text" size={42} />
                           </div>
                           <div>
                             <h1 className="text-6xl font-black text-white font-orbitron tracking-tighter neon-gradient-text uppercase leading-none mb-2">MEMORY MANAGER</h1>
                             <div className="flex items-center gap-4">
                                 ...
                                 <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] font-orbitron opacity-60">Physical_Address_Mode: ACTIVE</span>
                             </div>
                           </div>
                        </div>
                        <p className="text-text/40 text-xs font-bold uppercase tracking-widest max-w-2xl leading-loose ml-28">
                      ...
                      <div className="flex items-center gap-8 bg-black/40 p-4 rounded-[2rem] border border-white/5 backdrop-blur-md">
                         <div className="text-center px-8 border-r border-white/5">
                            <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1 font-orbitron">Current_Policy</p>
                            <p className="text-lg font-black text-white font-orbitron neon-text-cyan">{memoryStats.current_algorithm?.replace('_', ' ')}</p>
                         </div>
                         <div className="text-center px-8">
                            <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1 font-orbitron">Heap_Status</p>
                            <p className="text-lg font-black text-success font-orbitron neon-text-success">SYNCHRONIZED</p>
                         </div>
                      </div>
                   </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
               ...
               <motion.div variants={itemVariants} className="lg:col-span-8 space-y-12">
                  <div className="glass-premium rounded-[3.5rem] border border-white/10 p-12 relative overflow-hidden group shadow-[0_0_50px_rgba(0,209,255,0.05)]">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-8 relative z-10">
                      <div>
                        <h3 className="text-2xl font-black text-white flex items-center gap-4 font-orbitron tracking-tight">
                          <LuLayers className="text-secondary neon-text-cyan" /> HOLOGRAPHIC_RAM_MAP
                        </h3>
                      ...
                      <div className="flex bg-black/60 p-1.5 rounded-[1.2rem] border border-white/10 shadow-2xl backdrop-blur-xl">
                        {[
                          ...
                          <button 
                            ...
                            className={`flex items-center gap-3 px-6 py-2.5 rounded-xl text-[9px] font-black tracking-widest transition-all font-orbitron ${
                              memoryStats.current_algorithm === algo.id 
                                ? 'bg-gradient-to-r from-secondary to-blue-600 text-white shadow-[0_0_30px_rgba(0,209,255,0.4)] border border-white/20' 
               ...
               <motion.div variants={itemVariants} className="lg:col-span-4 space-y-12">
                  <div className="glass-premium rounded-[3rem] border border-white/10 p-10 relative overflow-hidden group shadow-[0_0_40px_rgba(255,77,109,0.05)]">
                     <div className="absolute inset-0 scanline-overlay opacity-10 pointer-events-none" />
                     
                     <div className="flex items-center gap-5 mb-10">
                        <div className="w-12 h-12 rounded-2xl bg-error/20 border border-error/30 flex items-center justify-center neon-border-error shadow-[0_0_20px_rgba(255,77,109,0.2)]">
                            <LuSettings className="text-error neon-text-error" size={24} />
                        </div>
                        <div>
                          <h3 className="text-xl font-black text-white font-orbitron tracking-[0.2em] uppercase">KERNEL_CONTROL</h3>
                          <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.3em] mt-1 font-orbitron">Privileged_Instruction_Node</p>
                        </div>
                     </div>

                     <div className="space-y-6">
                        <div className="p-6 rounded-[2rem] bg-error/5 border border-error/10 relative group/btn overflow-hidden">
                        ...
                        <div className="flex items-center gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                           <LuShieldAlert className="text-slate-500" size={16} />
                  ...
                  <div className="glass-premium rounded-[3rem] border border-white/10 p-10 relative overflow-hidden group shadow-[0_0_40px_rgba(0,209,255,0.05)] h-fit">
                     <div className="absolute inset-0 scanline-overlay opacity-5 pointer-events-none" />
                     
                     <div className="flex items-center gap-5 mb-10">
                        <div className="w-12 h-12 rounded-2xl bg-secondary/20 border border-secondary/30 flex items-center justify-center neon-border-secondary">
                            <LuTerminal className="text-secondary neon-text-cyan" size={24} />
                        </div>
                        <div>
                          <h3 className="text-xl font-black text-white font-orbitron tracking-[0.2em] uppercase">PHYS_JOURNAL</h3>
