...
const SnapshotCenter = () => {
  ...
  return (
    <DashboardLayout title="SNAPSHOT CENTER">
      <div className="relative z-10 space-y-10 pb-12 animate-in fade-in duration-700">
             ...
             <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 relative z-10">
               <div className="space-y-4">
                 <div className="flex items-center gap-5">
                    <div className="w-14 h-14 rounded-2xl bg-primary/20 border border-primary/30 flex items-center justify-center neon-border">
                        <LuCamera className="text-primary neon-text" size={32} />
                    </div>
                    <div>
                      <h1 className="text-5xl font-black text-white font-orbitron tracking-tighter neon-gradient-text uppercase leading-none mb-1">SNAPSHOT CENTER</h1>
               ...
               <div className="flex flex-col items-end gap-6">
                  ...
                  <button 
                      ...
                      className={`group/btn relative px-8 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] font-orbitron transition-all hover:scale-105 active:scale-95 overflow-hidden border ${kernelState.checkpointEnabled ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' : 'bg-white/5 text-slate-400 border-white/10'}`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="glass-premium p-8 rounded-[2.5rem] border border-white/10 flex flex-col space-y-8 relative overflow-hidden group">
              ...
              <div className="space-y-6 relative z-10">
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-primary/50 transition-all font-mono text-sm placeholder:text-white/10"
                  />
                </div>
                ...
                <button 
                  ...
                  className="group/btn relative w-full bg-primary/20 hover:bg-primary/30 disabled:opacity-30 disabled:cursor-not-allowed text-primary border border-primary/30 py-5 rounded-2xl transition-all font-black uppercase tracking-[0.3em] font-orbitron flex items-center justify-center gap-4 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700" />
              ...
              {kernelState.snapshotProgress && (
                <div className="mt-8 p-6 bg-primary/10 border border-primary/20 rounded-2xl animate-pulse relative z-10">
          ...
          <div className="lg:col-span-8">
            <div className="glass-premium p-8 rounded-[2.5rem] border border-white/10 flex flex-col space-y-8 h-full relative overflow-hidden group">
              ...
              {history.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-white/5 rounded-[2rem] min-h-[300px] relative z-10">
