...
const Settings = () => {
  ...
  const categories = [
    ...
    { id: 'scheduler', label: 'Scheduler_CFG', icon: <LuCpu size={18} /> },
             ...
             <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 relative z-10">
               <div className="space-y-4">
                 <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h1 className="text-5xl font-black text-white font-orbitron tracking-tighter neon-gradient-text uppercase leading-none mb-1">SETTINGS</h1>
               ...
               <div className="flex items-center gap-4 bg-white/5 p-3 rounded-2xl border border-white/10 backdrop-blur-md">
                 <button 
                   onClick={handleSave}
                   disabled={isSaving}
                   className={`px-8 py-3 rounded-xl bg-primary text-white text-[10px] font-black uppercase tracking-[0.2em] font-orbitron flex items-center gap-3 transition-all hover:shadow-[0_0_20px_rgba(157,0,255,0.4)] hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed`}
                 >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3 space-y-3">
            {categories.map((cat) => (
              <motion.button
                ...
                className={`w-full flex items-center gap-4 p-5 rounded-2xl transition-all border font-orbitron ${
            ...
            <div className="mt-12 p-6 glass border-white/5 rounded-3xl opacity-40">
          ...
          <div className="lg:col-span-9">
            <motion.div 
              ...
              className="glass-premium border-white/10 rounded-[2.5rem] p-10 space-y-10"
            >
              ...
              <div className="space-y-8">
                {settingsMap[activeCategory].map((setting, idx) => (
                  <div key={idx} className="group p-6 bg-white/2 rounded-3xl border border-white/5 hover:border-white/10 hover:bg-white/[0.04] transition-all">
              ...
              <div className="pt-10 flex items-center gap-4 border-t border-white/5 opacity-40 group hover:opacity-100 transition-opacity">
